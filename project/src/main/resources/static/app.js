(function () {
    ...
    function run($rootScope, $translate, $translatePartialLoader, $location, $cookieStore, $http) {
        ...
        $rootScope.language = $cookieStore.get('wiittymanager.language');
	    ...
	    $cookieStore.put('wiittymanager.language', $rootScope.language);
	    
        // keep user logged in after page refresh
        $rootScope.globals = $cookieStore.get('wiittymanager.globals') || {};
